...
To build the final jar and optimize the SchoolPayNotificationService application for production, run:
...
Then navigate to [http://localhost:9085](http://localhost:9085) in your browser.
